...
namespace AluGo.Migrations
{
    ...
    [Migration("20250901220238_NomeImovel")]
            ...
            modelBuilder.Entity("AluGo.Domain.Pessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("bf42432b-f9f8-43c1-9da2-5d3ce7af0302"),
                            Ativo = true,
                            CriadoEm = new DateTime(2025, 9, 1, 19, 2, 38, 688, DateTimeKind.Local).AddTicks(2533),
