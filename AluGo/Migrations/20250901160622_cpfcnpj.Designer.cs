...
namespace AluGo.Migrations
{
    ...
    [Migration("20250901160622_cpfcnpj")]
            ...
            modelBuilder.Entity("AluGo.Domain.Pessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("6cc8e056-fbfe-45d3-89a6-1aba99a76eb2"),
                            Ativo = true,
                            CriadoEm = new DateTime(2025, 9, 1, 13, 6, 21, 384, DateTimeKind.Local).AddTicks(281),
