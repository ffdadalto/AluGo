...
namespace AluGo.Migrations
{
    ...
    [Migration("20250902002714_ultimaEdicao")]
    partial class ultimaEdicao
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("AluGo.Domain.Pessoa", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = new Guid("c891e929-90d0-4e6a-b0c7-ded3858b0b8a"),
                            Ativo = true,
                            CriadoEm = new DateTime(2025, 9, 1, 21, 27, 12, 378, DateTimeKind.Local).AddTicks(8001),
